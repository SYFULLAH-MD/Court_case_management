        ...
        switch(choice)
        {
            case 1:for(int i=1;i<=8;i++)
               ...
               try
               {
                 ...
                 w.close();
                 System.out.println("appointment applied"); Javapro j=new Javapro();
                }
               catch(Exception e)
               {
                System.out.println("not wrriten to the file\nfailed!!!!!!!!!!!!!!!");
                System.out.println("please try again"); Javapro j=new Javapro();
               }
                   break;
...
public class Javapro
{
    ...
    Javapro()
    {
        ...
        //System.out.println("3.recieptionist");
        //System.out.println("4.hospital admin");
        n=sc.nextInt();
        if(n==1)
        {
            Pat p=new Pat();
